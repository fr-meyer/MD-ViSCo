...
@dataclass
class PulseDBApproximationPPG2ABPConfig(PulseDBBaseConfig):
    """PulseDB dataset configuration using PPG2ABP framework (UNetDS64 model).
        ...
        try:
            ...
            if hasattr(self, 'extract_waveform_features') and self.extract_waveform_features:
                ...
                with torch.no_grad():
                    ...
                    features_dir = os.path.join('./results/features_extraction', 'PulseDB', 'PPG2ABP', f'seed_{self.seed}')
