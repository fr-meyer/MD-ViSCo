...
@dataclass
class UCIApproximationPatchTSTConfig(UCIBaseConfig):
    """UCI dataset configuration for PatchTST model.
    ...
    context_length: int = 1024  # Length of input sequence
        ...
        try:
            ...
            if hasattr(self, 'extract_waveform_features') and self.extract_waveform_features:
                ...
                with torch.no_grad():
                    ...
                    features_dir = os.path.join('./results/features_extraction', 'UCI', 'PatchTST', f'seed_{self.seed}')
                    ...
                    with tqdm(test_loader, unit="batch", ncols=125) as tepoch_test:
                        ...
                        for batch_idx, test_file in enumerate(tepoch_test):
                            ...
                            with tqdm(range(batch_size), unit="sample", ncols=100, leave=False) as pbar:
                                ...
                                for i in pbar:
                                    # Calculate global index from batch index and sample index
