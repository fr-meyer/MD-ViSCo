...
@dataclass
class PulseDBApproximationP2EWGANConfig(PulseDBBaseConfig):
    """PulseDB dataset configuration for P2E-WGAN model.
            ...
            try:
                ...
                if hasattr(self, 'extract_waveform_features') and self.extract_waveform_features:
                    ...
                    with torch.no_grad():
                        ...
                        features_dir = os.path.join('./results/features_extraction', 'PulseDB', 'P2EWGAN', f'seed_{self.seed}')
